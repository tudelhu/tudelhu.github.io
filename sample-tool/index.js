...
(function() {
  ...
  var deviceOrientationControlMethod = new DeviceOrientationControlMethod(); // Neu
  controls.registerMethod('deviceOrientation', deviceOrientationControlMethod); // Neu
  ...
  toggleElement.setAttribute('id', 'toggleDeviceOrientation');
  toggleElement.setAttribute('href', 'javascript:void(0)');

  var toggleElementImgEnable = document.createElement('IMG');
  toggleElementImgEnable.setAttribute('class', 'enable');
  toggleElementImgEnable.setAttribute('src', 'img/enable.png');

  var toggleElementImgDisable = document.createElement('IMG');
  toggleElementImgDisable.setAttribute('class', 'disable');
  toggleElementImgDisable.setAttribute('src', 'img/disable.png');

  toggleElement.appendChild(toggleElementImgEnable);
  toggleElement.appendChild(toggleElementImgDisable);
